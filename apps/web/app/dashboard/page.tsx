      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <p className="text-3xl font-bold text-blue-600">{metrics.totalLeads.toLocaleString()}</p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm text-gray-600">Active Leads</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-green-600">{metrics.activeLeads.toLocaleString()}</p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-3xl font-bold text-purple-600">{metrics.emailsSent.toLocaleString()}</p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-3xl font-bold text-orange-600">{metrics.openRate}%</p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-3xl font-bold text-red-600">{metrics.clickRate}%</p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm text-gray-600">Reply Rate</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-indigo-600">{metrics.replyRate}%</p>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm">Email campaign "Q4 Outreach" started</p>
